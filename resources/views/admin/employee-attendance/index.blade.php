...
<div class="page-header">
    <div class="page-header-content">
        ...
        {{-- <a href="{{ route('admin.employee-attendance.create') }}" class="btn-add">
...
<!-- Employee Filter -->
<form method="GET" action="{{ route('admin.employee-attendance.index') }}" class="employee-filter"
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="{{ route('admin.employee-attendance.show', $log) }}" class="btn-action btn-action-view" title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('admin.employee-attendance.edit', $log) }}" class="btn-action btn-action-edit" title="Edit">
